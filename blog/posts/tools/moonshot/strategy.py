...
from docs.blog.posts.tools.moonshot.moonshot import Moonshot
...
def main():
    ...
    bars_store = ParquetUnifiedStorage(
        store_path=store_path, fetch_data_func=fetch_bars
    )
    ...
    dv_store = ParquetUnifiedStorage(
        store_path=store_path, fetch_data_func=fetch_dv_ttm
    )
