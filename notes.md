...
### 按国家英文名A-Z排序的知名大学清单（2026 QS排名标准）
说明：
1.  每个国家至少列1所大学；
2.  QS前100的大学**全部列出**，无QS前100则列该国最著名的1所大学；
3.  所有名称均为英文官方表述。
...
9.  **France**
    Paris Sciences et Lettres University (28)
    École Polytechnique (41)
    Paris-Saclay University (70)
...
12. **Hong Kong, China**
    ...
    The Chinese University of Hong Kong (32)
...
16. **Japan**
    ...
    Kyoto University (57)
    Osaka University (91)
    Tokyo Institute of Technology (85)

17. **Korea, South**
    Seoul National University (36)
    Yonsei University (50)
    Korea University (61)
...
27. **Switzerland**
    ETH Zurich - Swiss Federal Institute of Technology Zurich (7)
    École Polytechnique Fédérale de Lausanne (22)
    University of Zurich (100)

28. **Taiwan, China**
    National Taiwan University (63)
