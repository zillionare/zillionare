...
<div class="card">
    <a href="https://blog.quantide.cn/blog/posts/career&figure/max-dama-on-automated-trading/">
    <img class="card-img-top img-responsive" src="https://cdn.jsdelivr.net/gh/zillionare/imgbed2@main/images/2026/01/20260114202111.png"/>
    <div class="card-body">
        <h4 class="card-title">我之为我，有路可寻：量化传奇 Max Dama 的非典型量化之路</h4>
        <p class="card-text">讲述量化传奇 Max Dama 的逆袭之路：从冲浪少年到伯克利“四学位”学霸，再到高频交易核心。深入剖析 HFT 行业的垂直整合、透明文化及极短反馈机制，并分享他对 AI 应用与量化求职的独到见解。</p>
        <p class="card-text"><small class="text-muted"><i class="fa fa-calendar"></i>2026-01-15</small></p>
    </div>
    </a>
</div><!--end-card-->
