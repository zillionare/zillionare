...
tags: 
    - 机器学习
    - 强化学习
excerpt: "!!! abstract 内容摘要 强化学习已在摩根大通及全球顶级投资机构中使用。 与监督学习不同，强化学习不会在每一步都只接受标准答案，它会尝试、忍受短期的损失，博取长期的收益。这就使得它有了对抗金融数据噪声的能力。 奖励是强化学习的灵魂。我们可以直接把投资组合的收益率作为奖励。在监督学习中，损失函数是其核心，但我们"
---
