...
excerpt: "scipy当中有一些信号处理函数，可以用来发现顶和底，比如argrelextrema。 比函数名上看，这是一个寻找相对极值点坐标的函数。我们来看一下它的用法："
---
...
![](https://cdn.jsdelivr.net/gh/zillionare/images@main/images/202110/20211030231630.png)
...
![](https://cdn.jsdelivr.net/gh/zillionare/images@main/images/202110/20211102215632.png)
上图是截止9月3日的图。从后面的结果来看，`argrelextrem`应该在这一天标注出一个底点。但是它并没有。
![](https://cdn.jsdelivr.net/gh/zillionare/images@main/images/202110/20211102215539.png)
...
![](https://cdn.jsdelivr.net/gh/zillionare/images@main/images/202111/20211111170152.png)
