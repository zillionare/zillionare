...
.step-0-bg {
    background-image: url('https://cdn.jsdelivr.net/gh/zillionare/images@main/images/2024/07/why-alphalens-quantiles-overlap.jpg')
}
.step-1-bg {
  background-image: url('https://cdn.jsdelivr.net/gh/zillionare/images@main/images/2024/07/cut-by-quantile-small.png');
}
</style>
